        ...
        <>
            ...
            <main className='landing-main'>
                        ...
                        <div className='row align-items-center g-5'>
                            <div className='col-md-6'>
                                <h1 className='landing-heading'>
                                    Lost at the gym? We’ve been there.
                                </h1>
                                <p className='landing-subtext'>
                                    Get a weekly plan built for your body. Train
                                    with your friends—even at different levels.
                                </p>
                                <button
                                    className='btn btn-primary text-white fw-semibold'
                                    onClick={() => openModal('register')}
                                ...
                                <div className='landing-trust'>
                                    Built by real gym-goers, not influencers
                                </div>
                            </div>
                            <div className='col-md-6'>
                                <img
                ...
                <section className='landing-section text-center'>
                    <div className='container'>
                        <h2 className='landing-subheading'>
                            Starting shouldn’t feel like a test.
                        </h2>
                        <p className='landing-paragraph'>
                            You signed up. You show up. But now what? No coach,
                            no plan, no one to guide you. And if your friends
                            are stronger or newer—it’s awkward.
                            <br />
                    ...
                    <div className='container'>
                        <div className='row align-items-center g-5'>
                            <div className='col-md-6'>
                                ...
                                <p className='landing-paragraph'>
                                    No guesswork. No planning. Just open the app
                                    and start.
                                </p>
                                <a
                                    href='#how-it-works'
                ...
                <section className='landing-section landing-benefits text-center'>
                    <div className='container'>
                        <h2 className='landing-subheading mb-4'>
                            Why You’ll Love It
                        </h2>
                        <div className='row g-3'>
                            {[
                                {
                                    text: 'Tailored plans every week',
                                    icon: 'fa-calendar-check',
                                },
                                {
                                    text: 'Works solo or with your group',
                                    icon: 'fa-users',
                                },
                                {
                                    text: 'Built for your body and goals',
                                    icon: 'fa-dumbbell',
                                },
                                {
                                    text: 'Tap-to-learn tutorials',
                                    icon: 'fa-chalkboard-teacher',
                                },
                                {
                                    text: 'New every week to stay motivated',
                                    icon: 'fa-sync-alt',
                                },
                            ].map(({ text, icon }, i) => (
                                <div key={i} className='col-md-4 col-sm-6'>
                                    <p>
                                        <i
                                            className={`fas ${icon} text-accent me-2`}
                                        ></i>
                                        {text}
                                    </p>
                                </div>
                ...
                <section className='landing-section' id='how-it-works'>
                    <div className='container'>
                        <div className='row align-items-center'>
                            ...
                            <div className='col-md-6'>
                                <h2 className='landing-subheading mb-5'>
                                    How It Works
                                </h2>
                ...
                <section className='landing-section text-center'>
                    <h2 className='landing-heading'>
                        Less planning. More lifting.
                    </h2>
                    <p className='landing-subtext'>
                        Start your weekly plan today—tailored to you, synced
                        with your crew.
                    </p>
                    <button
                        className='btn btn-primary text-white fw-semibold'

...
export default function WorkoutEditModal({
    ...
    const handleSave = async e => {
        ...
        try {
            ...
            const res = await fetch(
                `${import.meta.env.VITE_API_URL}/schedule/workout/update`,
                {
                    method: 'PATCH',
                    headers: {
    ...
    const handleReset = async () => {
        ...
        try {
            ...
            const res = await fetch(
                `${import.meta.env.VITE_API_URL}/schedule/workout/reset`,
                {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
            ...
            if (res.ok && data.updatedWorkout) {
                ...
                toast.show(
                    'danger',
                    data?.error || '❌ Failed to reset workout'
                );
            }
        } catch (err) {
